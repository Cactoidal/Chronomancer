...
contract TestSender is CCIPReceiver, OwnerIsCreator {
    ...
    /// @param _endpoint The address of the endpoint on the destination blockchain.
    /// @param _recipient The address of the recipient on the destination blockchain.
    ...
    /// @param _endpoint The address of the endpoint.
